...
tput sgr0
tput setaf 2 ; tput bold ; printf '%s' "openvpnsetup" ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Instalador do OpenVpn com o protocolo TCP e interface em português" ; echo ""
tput sgr0
