...
echo ""
echo "Ao utilizar o Freedom SSH' você concorda com os seguintes termos de uso:"
echo ""
echo "1. Você pode:"
echo "a. Instalar e usar o 'Freedom SSH' no(s) seu(s) servidor(es)."
...
tput setaf 7 ; tput setab 4 ; tput bold ; echo "Mod by Samuel Lacerda" ; tput sgr0
echo ""
if [[ "$optiondb" = '2' ]]; then
	awk -F : '$3 >= 500 { print $1 " 1" }' /etc/passwd | grep -v '^nobody' > /root/usuarios.db
fi
